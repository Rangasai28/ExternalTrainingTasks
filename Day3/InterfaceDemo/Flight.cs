...
namespace InterfaceDemo
{
    public abstract class Flight
    {
        ...
        //Virtual method that Check's BaggageAllowance
        public virtual string CheckBaggageAllowance()
        {
            return "CheckBaggageAllowance";
        }


        //Method That Tells about the Flight Delay Status
        public string FlightDelayStatus(int hours)
        {
